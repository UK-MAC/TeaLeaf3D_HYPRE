...
!$ INTEGER :: OMP_GET_THREAD_NUM
  ...
  INTEGER :: numit, est_itc, cheby_calc_steps, max_cheby_iters, info, switch_step, petsc_mod, itcount
...
! This is the old implmentation which is wrong. The correct version in in the
! refernce version of Tealeaf
!=================================================================================== 
